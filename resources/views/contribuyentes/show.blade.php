        ...
        <div class="col-md-12">
          <div class="page-header" style="overflow: hidden;">
            ...
            <div class="btn-group pull-right"> 
                @if($c->estado==1)         
              <button title="Dar de baja" class="btn btn-danger">
                  <i class="fa fa-thumbs-o-down"></i>
              </button>
            @else 
            <button title="dar de alta" class="btn btn-success">
                <i class="fa fa-thumbs-o-up"></i>
            </button>
            @endif
              <button class="btn btn-primary" tooltip-placement='bottom' uib-tooltip='Editar contribuyente'>
            ...
            <div class="tab-content">
                <div class="active tab-pane" id="inmuebles" style="max-height: 580px; overflow-y: scroll; overflow-y: auto;">
                    <div class="col-xs-12 table-responsive" style="padding-top: 30px;">
                        <div class="col-xs-12">
                            <div class="btn-group pull-right">
                              <button class="btn btn-primary" tooltip-placement='left' tooltip='Agregar inmueble'>
                ...
                <div class="tab-pane" id="negocios" style="max-height: 580px; overflow-y: scroll; overflow-y: auto;">
                    <div class="col-xs-12">
                        <div class="btn-group pull-right">
                          <button class="btn btn-primary" tooltip-placement='left' title='Agregar inmueble'>
                            <i class="fa fa-plus-circle"></i>
                          </button>
                        </div>
                      </div>
