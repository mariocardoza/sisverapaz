...
<h1>
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="{{ url('/contribuyentes/pagos/'.$negocio->contribuyente->id) }}"><i class="fa fa-money"></i> Pagos</a></li>
        <li class="active">pago del negocio</li>
      </ol>
@endsection
    ...
    <div class="row">
        <div class="col-md-12">
          <div class="page-header" style="overflow: hidden;">
            <div class="pull-left">
              <i class="fa fa-user"></i> {{$negocio->contribuyente->nombre}}<br />
              <small style="margin-top: 0px; margin-left: 28px">Cuenta N°: {{$negocio->numero_cuenta}}</small>
            </div>
          </div>
        </div>
        <div class="col-md-12">
            <a href="{{ url('/contribuyentes/pagos/'.$negocio->contribuyente->id) }}" class="btn btn-primary pull-right">Atrás</a>
          </div>
      </div>
      ...
      <div class="row">
        <div class="invoice-info" >   
            ...
            <div class="col-sm-4 invoice-col">
              <b>Nombre del negocio:</b> {{$negocio->nombre}}<br>
              <b>Rubro:</b> {{$negocio->rubro->nombre}}<br>
              <b>Capital:</b> ${{number_format($negocio->capital,2)}}<br>
             </div>
            <!-- /.col -->
            <div class="col-sm-4 invoice-col">
             <b>Dirección: </b>      
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                          <div class="btn-group text-align">
                            ...
                            <a class="btn btn-success ver pagos" href="{{url('verfacturaspendientesn?cbid='.$i->id)}}" data-id="{{$i->id}}" target="_blank">
